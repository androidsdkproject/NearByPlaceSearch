...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Adding new contact
    void addPlaceItem(PlaceItem loc) {
    ...
    PlaceItem getLocation(int id) {
        ...
        PlaceItem list = new PlaceItem(cursor.getString(0),
    ...
    public List<PlaceItem> getAllPlace() {
        List<PlaceItem> globallist = new ArrayList<PlaceItem>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                PlaceItem locallist = new PlaceItem();
    ...
    public int updateContact(PlaceItem list) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteLocation(PlaceItem list) {
        SQLiteDatabase db = this.getWritableDatabase();
